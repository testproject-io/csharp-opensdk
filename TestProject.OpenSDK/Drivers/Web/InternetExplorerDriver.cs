...
namespace TestProject.OpenSDK.Drivers.Web
{
    ...
    public class InternetExplorerDriver : BaseDriver
    {
        ...
        public InternetExplorerDriver(
            ...
            : base(remoteAddress, token, DriverOptionsHelper.Patch(internetExplorerOptions, BrowserType.InternetExplorer), projectName, jobName, disableReports, reportType, reportName, reportPath, remoteConnectionTimeout, restClientTimeout)
        {
        }
    }
}
