// <copyright file="BrowserStackCloudDriverTest.cs" company="TestProject">
...
namespace TestProject.OpenSDK.Tests.Examples.Drivers
{
    ...
    /// </summary>
    [TestClass]
    public class BrowserStackCloudDriverTest
    {
        /// <summary>
        ...
        public void StartBrowser()
        {
            ...
            chromeOptions.AddAdditionalCapability("browser_version", "latest", true);
            ...
            chromeOptions.AddAdditionalCapability("browserstack.key", "{YOUR_KEY}", true);
            chromeOptions.AddAdditionalCapability(TestProjectCapabilityType.CLOUD_URL, "https://hub-cloud.browserstack.com/wd/hub/", true);
