// <copyright file="TestProjectStepContext.cs" company="TestProject">
...
namespace TestProject.OpenSDK.SpecFlowPlugin
{
    ...
    /// </summary>
    public static class TestProjectStepContext
    {
        /// <summary>
        /// The name of the current SpecFlow step in execution.
        /// </summary>
        public static string CurrentStep { get; set; }

        /// <summary>
        /// The name of the current SpecFlow scenario in execution.
        /// </summary>
